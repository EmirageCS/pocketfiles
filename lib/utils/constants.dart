...
abstract final class StorageKeys {
  ...
  /// Per-folder lockout cycle counter — increments each time the folder is
  /// brute-force locked; resets on successful unlock.  Used to compute
  /// exponential backoff durations (60 s → 5 min → 30 min).
  static String lockoutCount(int folderId) => 'lockoutCount_$folderId';
}
