...
///
/// **Responsibilities (this controller):**
/// - Folder list CRUD (create, rename, delete, reorder, color)
/// - Home-screen folder search (filter by name — client-side, no DB query)
/// - Folder sort mode (custom / name / date) with persistence
/// - Lock/unlock toggle for individual folders
///
/// **Not here — see [FolderController]:**
/// - File operations (add, rename, delete, reorder) within a folder
/// - Per-folder file search and sort
/// - PIN unlock flow and brute-force tracking
